...
/**
 * OpenAI logomark — SVG path from Simple Icons v11 (CC0). The icon was later removed
 * from the main package; we keep the path here for OpenAI Codex.
 */
const OPENAI_SIMPLE_ICON_PATH =
    ...
    case 'codex':
      return (
        <svg viewBox="0 0 24 24" className={cn} aria-hidden role="img">
          <path fill="currentColor" d={OPENAI_SIMPLE_ICON_PATH} />
        </svg>
      );
    case 'v0':
